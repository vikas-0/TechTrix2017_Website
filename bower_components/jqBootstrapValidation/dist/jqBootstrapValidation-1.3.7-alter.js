    ...
    methods: {
      init : function( options ) {
        ...
        $(uniqueForms).bind("submit", function (e) {
          var $form = $(this);
          var warningsFound = 0;
          var $inputs = $form.find("input,textarea  ").not("[type=submit],[type=image]").filter(settings.options.filter);
        ...
        return this.each(function(){
          ...
          $this.bind(
            ...
            function (e, params) {
              ...
              $controlGroup.find("input,textarea  ").each(function (i, el) {
              ...
              $form.find("input  ,textarea").not($this).not("[name=\"" + $this.attr("name") + "\"]").trigger("validationLostFocus.validation");
      ...
      hasErrors: function() {
        ...
        this.find('input  ,textarea').add(this).each(function (i, el) {
